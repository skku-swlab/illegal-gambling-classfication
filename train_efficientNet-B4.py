...
# 하이퍼파라미터 설정
img_size = (380, 380)  # EfficientNet-B4에 맞는 입력 크기
batch_size = 64  # 더 큰 배치 크기로 설정
epochs = 10
learning_rate = 0.001
model_save_path = "./model/image_classification_model_b4.h5"  # 저장 경로
...
with strategy.scope():
    # ImageNet으로 전이 학습된 EfficientNet-B4 모델 로드
